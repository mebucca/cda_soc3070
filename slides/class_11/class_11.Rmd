...
style_duo_accent(
  primary_color = "#FF00FF",       # Electric magenta
  secondary_color = "#00FFFF",     # Cyan / aqua
  background_color = "#FAF9F6",    # Deep cosmic purple
  header_font_google = google_font("Archivo"), 
  text_font_google = google_font("Inconsolata"), # Monospaced
  link_color = "#FAF9F6"           # Neon green
)
```
