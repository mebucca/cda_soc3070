...
subtitle: "Regresión Logística -  Inferencia"
...
style_duo_accent(
  primary_color = "#C41E3A",       # Valentino deep red
  secondary_color = "#000000",     # Black for contrast
  background_color = "#FAF9F6",    # Cream/soft white
  header_font_google = google_font("Archivo"),  
  text_font_google = google_font("Inconsolata"),         # Monospaced for clarity (or "Lora" for elegance)
  link_color = "#DAA520"           # Gold accent for links
)
```
