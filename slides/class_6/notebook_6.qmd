...
legend.title = element_text(color=julia$navy, size=13, face="bold"),
legend.text = element_text(color=julia$teal, size=12),
axis.line = element_line(color=julia$navy),
axis.ticks = element_line(color=julia$navy),
