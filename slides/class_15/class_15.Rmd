...
Considerando las últimas dos semanas (previo a el día 19 de noviembre), el promedio de muertes diarias por Covid-19 en el mundo es de 8651.35
...
- El parámetro de esta variable es $\mu=8651.35$, consistente en la .bold[media] de muertes diarias. 
...
.bold[Pregunta]: ¿Cuál es la probabilidad de observar un determinado número $y$ de muertes diarias?
