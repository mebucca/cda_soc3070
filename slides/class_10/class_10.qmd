...
- [Paso 4]{.bold}: re-ordebando los términos obtenemos el efecto marginal que buscamos:
...
## Efectos marginales sobre la probabilidad de éxito: MEM
Implentamos la tercera opción usando `marginaleffects` en `R`: efecto marginal para temperatura y tipo de día fijos a su promedio global.
