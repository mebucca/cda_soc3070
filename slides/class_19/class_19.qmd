...
La regularización reemplaza la selección **discreta** (combinatoria, inestable, la que un GLM clásico haría "a mano" comparando AIC entre modelos) por una **continua** — el mismo objetivo del stepwise selection de la clase 18, resuelto de forma más estable.
